...
HD_PWD='E:/Documents/Vivado/Basys3/Projects/smvp_systolic/smvp_systolic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log smvp_systolic_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source smvp_systolic_top.tcl -notrace
