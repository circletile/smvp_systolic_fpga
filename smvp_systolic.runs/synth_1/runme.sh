...
HD_PWD='E:/Documents/Vivado/Basys3/Projects/smvp_systolic/smvp_systolic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log smvp_systolic_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source smvp_systolic_top.tcl
